      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <button onClick={() => router.push('/jobs')} className="text-talentai-accent hover:text-talentai-accent/80 transition-colors">
              Find AI Jobs
            </button>
            <button onClick={() => router.push('/skill-challenge')} className="text-talentai-accent hover:text-talentai-accent/80 transition-colors">
              Skill Challenges
            </button>
            <button onClick={() => router.push('/interview')} className="text-talentai-accent hover:text-talentai-accent/80 transition-colors">
              AI Interviews
            </button>
            <button onClick={() => router.push('/signup')} className="bg-talentai-accent text-white px-6 py-2 rounded-lg hover:bg-talentai-accent/90 transition-all duration-300 transform hover:scale-105">
              Get Started
            </button>
          </nav>
